...
/**
 * Update resource status for all jobs in a production plan
 * @param levels - Array of planning levels
 * @param gameState - The current game state
 * @param initialWarehouseState - The initial warehouse state
 * @returns Updated levels with resource status for each job
 */
export function updateProductionPlanResourceStatus(
  levels: PlanningLevel[],
  gameState: GameState,
  initialWarehouseState: Map<string, number>
): PlanningLevel[] {
